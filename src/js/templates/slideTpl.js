...
export default (_element) => new Promise((resolve) => {
  ...
  slide.innerHTML = `<div class="slide__container">
                        ...
                        <div class="slide__bottom">
                          <a class="slide__title" href="https://www.imdb.com/title/${_element.imdbID}/videogallery/" target="_blank" alt="${_element.Title}">${_element.Title}</a>
                          <p class="slide__year">${_element.Year}</p>
                          <p class="slide__rating"><span class="raiting__star"></span>${_element.imdbRating}</p>
                        </div>
                    </div>`;
